...
public class StyleableTreeTableCell<S, T> extends TreeTableCell<S, T> {
    ...
    public StyleableTreeTableCell(StringConverter<T> converter, String ...styleClass) {
    ...
    public static <S> Callback<TreeTableColumn<S, String>, TreeTableCell<S, String>> forTableColumn(String ...styleClass) {
        return col -> new StyleableTreeTableCell<>(new DefaultStringConverter(), styleClass);
    }

    public static <S, T> Callback<TreeTableColumn<S, T>, TreeTableCell<S, T>> forTableColumn(StringConverter<T> converter, String ...styleClass) {
        return col -> new StyleableTreeTableCell<>(converter, styleClass);
    }
